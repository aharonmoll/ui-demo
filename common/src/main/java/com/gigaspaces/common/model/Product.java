...
public class Product implements Serializable {
    ...
    private Product(Integer id, String name, Integer age, Integer numOfFlights, Integer salary, CommunicationInfo communicationInfo) {
        this.id = id;
        this.name = name;
        this.age = age;
    ...
    public static Product createProduct(int id) {
        return new Product(id, RandomUtils.nextString(), RandomUtils.nextInt(),
